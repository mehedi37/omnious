...
const envSchema = z.object({
  ...
  OLLAMA_MODEL: z.string().min(1).default('qwen2.5-coder:7b-instruct'),
  OLLAMA_MODEL_FAST: z.string().min(1).default('qwen2.5-coder:7b-instruct'),
  OLLAMA_MODEL_POWERFUL: z.string().min(1).default('qwen2.5-coder:32b-instruct'),
