...
const envSchema = z.object({
  ...
  OLLAMA_MODEL_FAST: z.string().min(1).default('gemma4:latest'),
  OLLAMA_MODEL_POWERFUL: z.string().min(1).default('gemma4:latest'),
  ...
  // MemPalace — per-project AI memory storage
  MEMPALACE_DATA_DIR: z.string().default('/data/palaces'),
